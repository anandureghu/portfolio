...
import { Body, HighlightedTitle, Title } from "../styled/typography";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        id="projects"
      >
        <Title className="mb-8 ml">
          A <HighlightedTitle>Showcase</HighlightedTitle> of My Work
        </Title>
        ...
        <div className="flex items-center justify-center mt-8">
          <Link
            href={"https://github.com/anandureghu?tab=repositories"}
            target="_blank"
          >
            <Button
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        <Title className="text-left ml-0 justify-start text-7xl">
          The <HighlightedTitle className="text-7xl">Journey</HighlightedTitle>
        </Title>
        <Title className="text-left ml-0 justify-start text-7xl">So Far</Title>
      </h1>
      <Body className="mt-8 text-left max-w-screen-lg">
